...
class AdminController extends Controller
{
    ...
    public function brand_update(Request $request)
    {
        ...
        $brand->save();
        return redirect()->route('admin.brands')->with('status','Brand has updated added succesfuly!');
    ...
    public function category_store(Request $request)
    {
        ...
        $category->save();
        return redirect()->route('admin.brands')->with('status','Category has been added succesfuly!');
    }
    ...
    public function category_update(Request $request)
    {
        ...
        $category->save();
        return redirect()->route('admin.categories')->with('status','category has updated added succesfuly!');
    }
    ...
    public function product_store(Request $request)
    {
        $request->validate([
            ...
            'quantity' => 'required',
            'image' => 'required',
            'category' => 'required|mimes:png,jpg,jpeg|max:2048',
            'brand_id' => 'required'
        ]);
        ...
        if($request->hasFile('image'))
        {
            ...
            $this->GenerateProductThumbnailImage($image,$image);
        ...
        {
            $allowedfiledExtion = ['jpg','png','jpeg'];
            $files = $request->file('image');
            foreach($files as $file)
            {
                $gextension = $file->getClientOriginalExtension();
                $gcheck = in_array($gextension,$allowedfiledExtion);
                if($gcheck)
                {
    ...
    public function product_update(Request $request)
    {
        $request->validate([
            ...
            'quantity' => 'required',
            'image' => 'required',
            'category' => 'mimes:png,jpg,jpeg|max:2048',
            'brand_id' => 'required'
        ]);  
