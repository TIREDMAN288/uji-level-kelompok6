        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('admin.product.update')}}">
            ...
            <div class="wg-box">
                ...
                <fieldset class="description">
                    ...
                    <div class="text-tiny">Do not exceed 100 characters when entering th product name.</div>
                </fieldset>
        ...
        $(function() {
            ...
            $("#gFile").on("change",function(e){
                ...
                $.each(photos,function(key,val){
                    $("#galUpload").prepend(`<div class="items gitems"><img src="${URL.createdObjectURL(val)}" /></div>`);
                });
            });  
