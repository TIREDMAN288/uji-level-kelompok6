                ...
                <div class="col-md-12">
                    <div class="my-account__address-list">
                        <div class="my-account__address-list-item">
                            <div class="my-account__address-item_deatail">
                                <p>{{$address->name}}</p>
                                <p>{{$address->address}}</p>
              ...
              <div class="checkout__totals">
                ...
                <table class="checkout-totals">
                    <tbody>
                        <tr>
                          <th>Subtotal</th>
                          <td text="text-right">${{Cart::instance('cart')->subTotal()}}</td>
                        </tr>
                        <tr>
                          <th>Discount {{Session::get('coupon')['code']}}</th>
                          <td text="text-right">${{Session::get('discounts')['discount']}}</td>
                        </tr>
                        <tr>
                          <th>Subtotal After Discount</th>
                          <td text="text-right">${{Cart::get('discounts')->['subTotal']}}</td>
                        </tr>
                        <tr>
                          <th>Shipping</th>
                          <td>Free</td>
                        ...
                        <tr>
                          <th>VAT</th>
                          <td text="text-right">${{Cart::get('discounts')->['tax']}}</td>
                        </tr>
                        <tr>
                          <th>Total</th>
                          <td text="text-right">${{Cart::get('discounts')->['total']}}</td>
                        </tr>
                      </tbody>
                  </table>
                @else
                <table class="checkout-totals">
                  <tbody>
                    ...
                    <tr>
                      <th>SHIPPING</th>
                      <td text="text-right">Free shipping</td>
                    </tr>
                    <tr>
                      <th>VAT</th>
                      <td text="text-right">${{Cart::instance('cart')->tax()}}</td>
                    </tr>
                    <tr>
                      <th>TOTAL</th>
                      <td text="text-right">${{Cart::instance('cart')->total()}}</td>
                    </tr>
                  </tbody>
                </table>
                @endif
